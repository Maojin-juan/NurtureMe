...
export default function TeamSwiper() {
  ...
  return (
    <div className="relative px-[28px] 2xl:container">
      <div className="teamSwiper relative overflow-x-hidden pb-12 xl:pb-[72px]">
      ...
      <div className="hidden 3xl:block">
        <div className="swiper-button-next bg-arrowNext !-right-14 !top-[175px] !mt-0 !size-20 bg-cover after:hidden" />
        <div className="swiper-button-prev bg-arrowPrev !-left-14 !top-[175px] !mt-0 !size-20 bg-cover after:hidden" />
      </div>
    </div>
  );
}
